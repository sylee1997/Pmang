										...
										<thead>
											<tr>
												<td>
													...
													<button style="width: 290pt; background-color: yellow;" data-toggle="modal" data-target="#myModal">
														<div id="kakaoWrite">
															<img src="./image//kakao_icon.png" alt="kakao_icon" />
															<p>카카오 1초 로그인/회원가입</p>
														</div>
													</button>
													<button type style="width: 290pt; background-color: green; margin-top:13px;">
														<div id=memberWrite>
															<img src="./image//kakao_icon.png" alt="kakao_icon" />
															<p>일반 회원가입</p>
														</div>
