...
<tr>
	...
	<td>
		<input type="text" id="noticeSubject" size="100" name="noticeSubject" placeholder="공지사항 제목 입력">
...
<tr>
	...
	<td>
		<textarea rows="30" cols="100" id="noticeContent" name="noticeContent" placeholder="공지사항 내용 입력"></textarea>
	</td>
</tr>
<tr>
   <td colspan="2" align="center">
      <input type="button" value="공지사항 등록" id="reportWriteBtn">
...
$('#reportWriteBtn').on('click',function(){
	...
	$.ajax({
		...
		data:{'noticeSubject':$('#noticeSubject').val(),
