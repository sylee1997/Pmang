	...
	<div class="wirteForm_head">
		<nav class="writeForm_nav">
			...
			<div class="nav_managementForm">
				<a class="nav_move2" href="/pmang/board/sellerManagementForm"> 
				상품관리
				</a>
			</div>
						...
						<div class="stateArea_div">
							<div class="state_div">
								<label for="upper" class="state_upper">
									<input type="radio" name="condition" id="upper" value="0" checked>
									상
								</label>
								
								<label for="middle" class="state_middle">
									<input type="radio" name="condition" id="middle" value="1">
									중
								</label>
								
								<label for="lower" class="state_lower">
									<input type="radio" name="condition" id="lower" value="2">
									하
								</label>
							</div>
						</div>
						...
						<div class="negoArea_div">
							<div class="nego_div">
								...
								<label for="possibility" class="nego_possibility">
									<input type="radio" name="nego" id="possibility" value="1">
									가능
								</label>
							</div>
						</div>
...
<script type="text/javascript" src="../js/sellerModify.js"></script>
<script type="text/javascript">
window.onload=function() {
	
	document.sellerWriteForm.condition['${itemDTO.condition }'].checked = true;
	document.sellerWriteForm.nego['${itemDTO.nego }'].checked = true;
