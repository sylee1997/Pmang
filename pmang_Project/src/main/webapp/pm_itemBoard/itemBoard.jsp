		...
		<div class="locationModalContent">
			...
			<div class="locationModal_section">
				<ul>
					...
					<li><img src="../image/appointLocation.png"><a href="#">주요위치로 검색</a></li>
					<li><img src="../image/mapSearch.png"><a href="#">지도로 위치 검색</a></li>
				</ul>
			</div>
		</div>
	</div>
   ...
   <div class="selection01">
	...
	<div class="selection02">
		...
		<div class="locationSearch">
			<span class="locationSpan">내 위치 확인</span>
			<img src="data:image/png;base64,"
			 width="6" height="10" alt="카테고리 선택그룹 아이콘">
		</div>
...
$('#gpsBtn').click(function(){
	...
	var lon;
	 ...
	 $.ajax({
		    url: 'https://apis.daum.net/local/geo/coord2addr?apikey=87511b2e2ee2b53e6090f1d34f856e44&longitude=' + lon + '&latitude=' + lat + '&inputCoordSystem=WGS84&output=json',
		    type: 'GET',
		    cache: false,
		    context: {},
		    crossOrigin: true,
		    success: function(data) {
		        ...
		        $('.locationSpan').html("<br>동네 이름 : " + jsonObj.name + " / 전체 주소 : " + jsonObj.fullName + " / 나라 : " + jsonObj.name0);
