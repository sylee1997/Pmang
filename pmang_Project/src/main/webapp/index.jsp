	...
	<div id="wrap" style="border: 1px solid red">
		<div id="header" style="border: 1px solid red">
			...
			<div id="container" style="border: 1px solid black">
				...
				<div class="slide">
					<ul class="slide_wrap"
						style="width: 5120px; height: 200px; border: 2px solid blue;">
				...
				<div id="selection"
					...
					<div id="item"
						...
						<div id="itemPrice"
							style="width: 100px; height: 50px; border: 1px solid blue; float: left;"></div>
						<div id="itemUpload"
							style="width: 100px; height: 50px; border: 1px solid red; float: right;"></div>
		...
		<div class="footerContentArea">
			<div class="footerContent">
				<div class="footerContentMark">
					(피망장터이미지)피망장터
					<div class="footerContentMarkTitle">피나게 망하지 않을 만큼 판매하는 장터입니다.
						누구나, 무엇이든 쉽고 편하고 안전하게 거래할 수 있습니다.</div>
				</div>

				<div class="icon">
					<a href="#" target="_blank"> <img
						src="footerImage/facebook.png" alt="facebook icon"
						style="margin: 0px 5px 0px 16px;">
					</a> <a href="#" target="_blank"> <img
						src="footerImage/instagram.png" alt="instagram icon">
					</a>
				</div>
			</div>
