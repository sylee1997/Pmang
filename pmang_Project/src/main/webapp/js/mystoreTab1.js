			...
			$.each(data.list,function(index,items){
				 ...
				 */
					// $('#mystoreTab1PagingDiv').html(data.mystoreTab1Paging.pagingHTML);
						...
						itemLinkA += '<img src="/pmang/storage/'+items.img1+'" width="194" height="194" alt="상품이미지" style="opacity:0.4"><div class="itemSoldDiv">판매완료</div></a>';
