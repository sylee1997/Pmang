...
$(document).ready(function(){
	$.ajax({
		...
		success : function(data){
			...
			$('.itemSubject_input').val(data.itemDTO.item_subject);
			$('.location_input').val(data.itemDTO.item_location);
			$('.price_input').val(data.itemDTO.item_price);
